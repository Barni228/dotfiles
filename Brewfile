...
brew "luarocks"
# NCurses Disk Usage,, show what takes how much space in current directory
brew "ncdu"
...
brew "tmux"
# Color-based alternative to figlet (uses libcaca), draw text with characters
brew "toilet"
...
brew "yazi"
# Shell extension to navigate your filesystem faster, better cd
brew "zoxide"
