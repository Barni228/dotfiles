# Generated by Powerlevel10k configuration wizard on 2024-06-19 at 12:17 MDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # virtualenv              # python virtual environment (with user name) (https://docs.python.org/3/library/venv.html)
